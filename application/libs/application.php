...
class Application
{
    ...
    public function __construct()
    {
        ...
        if (file_exists(ROOT_DIR . '/application/controller/' . $this->url_controller . '.php')) {

            // if so, then load this file and create this controller
            // example: if controller would be "car", then this line would translate into: $this->car = new car();
            require ROOT_DIR . '/application/controller/' . $this->url_controller . '.php';
            ...
            require ROOT_DIR . '/application/controller/home.php';
            $home = new Home();
            $home->index();
        }
    }
